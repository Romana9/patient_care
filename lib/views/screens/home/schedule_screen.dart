                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: isSelected == 1
                              ? List.generate(
                                  PatientCubit.get(context).cancelList.length,
                                  (int index) {
                                  return Container(
                                          ...
                                          children: [
                                            Image(
                                              image: PatientCubit.get(context)
                                                  .cancelList[index]['image'],
                                              height: 50,
                                              width: 50,
                                            ),
                                            SizedBox(
                                              width:
                                                  KSize.getWidth(context, 14),
                                            ),
                                            Column(
                                              crossAxisAlignment:
                                                  CrossAxisAlignment.start,
                              ...
                              : List.generate(
                                  PatientCubit.get(context).upcomingList.length,
                                  (int index) {
                                  return Container(
                                    margin: EdgeInsets.only(
                                        bottom: KSize.getWidth(context, 30)),
